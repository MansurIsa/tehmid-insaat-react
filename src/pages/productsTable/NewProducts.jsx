...
const NewProducts = () => {
  ...
  const addArticle = () => {
    setFormData(prev => ({ ...prev, articles: [...prev.articles, ''] }));
  };
  ...
  const handleTitleChange = (index, value) => {
    ...
    updated[index] = value;
    setFormData(prev => ({ ...prev, titles: updated }));
  };
  ...
  const handleUnitChange = (e) => {
    ...
    setFormData(prev => ({
      ...prev,
      unit: value,
      // Əgər unit 'piece' deyilsə, çəki və uzunluq sahələrini təmizlə
  ...
  const handleSubmit = (e) => {
    ...
    // Unit 'piece' olduqda unit_weight və ya unit_length tələb olunur (istəyə bağlı)
    if (formData.unit === 'piece') {
      // İstəyə bağlı: ya unit_weight, ya da unit_length daxil edilməlidir
      // Bu hissəni istədiyiniz kimi tənzimləyə bilərsiniz
    }
          ...
          <div className="form_group">
            ...
            {previewUrl ? (
              <div className="image_preview_wrapper">
                <img src={previewUrl} alt="Məhsul şəkli" style={{ width: '150px', height: '150px', objectFit: 'cover', borderRadius: '8px', border: '1px solid #ccc' }} />
